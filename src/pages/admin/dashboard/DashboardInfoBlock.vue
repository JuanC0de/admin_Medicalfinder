            ...
            <table class="va-table">
              <thead>
                <tr>
                  ...
                  <th>Tipo Cita</th>
                  <th>Estado</th>
                  <th v-if="tipoPerfilUser">Info Paciente</th>
                  <th v-if="!tipoPerfilUser">Cancelar</th>
                </tr>
              </thead>
                ...
                <tr v-for="cita in lista" :key="cita.IdCita">
                  ...
                  <td v-if="!tipoPerfilUser">
                    <va-button
                      class="mr-2 mb-2"
                      color="danger"
                      @click="estadoCita(establecerIdCita('Cancelada', cita.IdCita))"
                    >
                      Cancelar
                    </va-button>
                  </td>
...
<script setup lang="ts">
  ...
  async function dataPerfil() {
    ...
    console.log('perfil', perfil, 'token:', token)
    console.log('Este es el tipo del perfil', tipoPerfilUser)
  }
